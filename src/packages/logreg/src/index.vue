<template>
  <div v-if="visibility" @click="close" :class="style" class="fzm-logreg-wrap">
    <div :class="[mode==='win'?'fzm-logreg-win':'fzm-logreg-mb']" @click="winclick" @click.stop>
      ...
      <div class="default" v-if="visible.step<4">
        ...
        <div class="tabc">
          ...
          <div v-if="visible.step==3" class="step3">
            ...
            <span class="check">
              <i class="fzm-icons" :class="{'fzm-icon-wancheng':userinfoIsRemember}"></i>
            </span>
            记住密码
          </span>
